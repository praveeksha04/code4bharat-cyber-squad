    ...
    try {
      ...
      xhr.upload.onprogress = (e) => {
        if (!e.lengthComputable)
          return onProgress && onProgress({ phase: "upload", percent: 0 });
      ...
      xhr.onprogress = (e) => {
        ...
        if (contentLength > 0 && e.lengthComputable) {
          const percent = Math.min(
            100,
            Math.round((e.loaded / contentLength) * 100)
          );
      ...
      xhr.onload = () => {
        ...
        const text = transcriptHeader
          ? decodeURIComponent(transcriptHeader)
          : "";
